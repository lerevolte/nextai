        ...
        <div class="bg-white shadow rounded-lg">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                    ...
                    <a href="#functions" class="tab-link border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                        Функции
                    </a>
            ...
            <div class="p-6">
                ...
                <div id="functions-content" class="tab-content hidden">
                    <div class="mb-4 flex justify-between items-center">
                        <h3 class="text-lg font-medium">Функции и автоматизации</h3>
                        <a href="{{ route('functions.create', [$organization, $bot]) }}" 
                           class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
                            + Создать функцию
                        </a>
                    </div>
                    ...
                    <div class="grid gap-4">
                        @forelse($bot->functions as $function)
                            <div class="border rounded-lg p-4">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h4 class="font-medium">{{ $function->display_name }}</h4>
                                        <p class="text-sm text-gray-600 mt-1">{{ $function->description }}</p>
                                        <div class="flex gap-2 mt-2">
                                            <span class="text-xs bg-gray-100 px-2 py-1 rounded">
                                                {{ ucfirst($function->trigger_type) }}
                                            </span>
                                            @if($function->is_active)
                                                <span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded">Активна</span>
                                            @else
                                                <span class="text-xs bg-gray-100 text-gray-800 px-2 py-1 rounded">Неактивна</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="flex gap-2">
                                        ...
                                        <a href="{{ route('functions.show', [$organization, $bot, $function]) }}" 
                                           class="text-gray-600 hover:text-gray-900">Подробнее</a>
                                    </div>
                                </div>
                            </div>
                        @empty
                            <div class="text-center py-8 bg-gray-50 rounded-lg">
                                <p class="text-gray-500 mb-4">Функции не созданы</p>
                                <a href="{{ route('functions.create', [$organization, $bot]) }}" 
                                   class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
