                ...
                <div style="display: flex; justify-content: space-between; align-items: start;">
                    <div style="flex: 1; margin-right: 20px;">
                        ...
                        <div style="display: flex; gap: 20px; font-size: 14px; color: #9ca3af; align-items: center;">
                            ...
                            <!-- Если есть история версий -->
                            @if($item->versions()->count() > 0)
                                <span style="display: flex; align-items: center; color: #6366f1;">
                                    <svg style="width: 16px; height: 16px; margin-right: 5px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    {{ $item->versions()->count() }} {{ Str::plural('версия', $item->versions()->count()) }} в истории
                                </span>
                            @endif
                            <span style="display: flex; align-items: center;">
                                <svg style="width: 16px; height: 16px; margin-right: 5px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        <a href="{{ route('knowledge.versions', [$organization, $bot, $item->id]) }}" 
                           style="padding: 8px 16px; background: #fbbf24; color: #78350f; text-decoration: none; border-radius: 5px; display: inline-flex; align-items: center;">
                            <svg style="width: 16px; height: 16px; margin-right: 5px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            История (v{{ $item->version }})
                        </a>
